...
digital_media_test_name = "digital_media_test"

digital_media_test_column_creator = \
        "media_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT," \
...
digital_media_test_columns = "`owner_id`, `name`, `description`, `file_path`,`thumbnail_path`, `category`, `price`, `approval`"

digital_media_test_entries = [
